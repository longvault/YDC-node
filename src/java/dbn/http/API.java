...
public final class API {
    ...
    static {
        List<String> disabled = Dbn.getStringListProperty("dbn.disabledAPIs");
        ...
        if (enableAPIServer) {
            ...
            if (!enableSSL || port != sslPort) {
                ...
                connector.setIdleTimeout(Dbn.getIntProperty("dbn.apiServerIdleTimeout"));
